...
def signin_handler(btn1, btn2, window):
   ...
   button_sub = tk.Button(window, text='Submit', command=lambda:signin_text_handler(user_name,user_password,back_button,button_sub,name_label,pass_label,secret_code,window))
   button_sub.grid(row=3, column=4)
   
   back_button = tk.Button(window, text='Back', fg='blue' ,command=lambda:main_menu(user_name,secret_code_entry,
